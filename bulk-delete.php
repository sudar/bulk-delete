...
use BulkWP\BulkDelete\Core\Posts\Metabox\DeletePostsByCustomTaxonomMetabox;
...
final class Bulk_Delete {
	...
	private function includes() {
		...
		require_once self::$PLUGIN_DIR . '/include/Core/Posts/Metabox/DeletePostsByCustomTaxonomMetabox.php';

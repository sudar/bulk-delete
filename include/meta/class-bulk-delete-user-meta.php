...
class Bulk_Delete_User_Meta {
	...
	public static function render_delete_user_meta_box() {
        ...
        <fieldset class="options">
            ...
            <table class="optiontable">
				...
				foreach ( $users_count['avail_roles'] as $role => $count ) {
                    ...
                    <tr>
                        <td>
                            <input name="smbd_um_role" value="<?php echo $role; ?>"
                                   type="radio" <?php checked( $role, 'administrator' ); ?>>
                            <label for="smbd_um_role"><?php echo $role; ?> (<?php echo $count . ' ';
            ...
            <table class="optiontable">
                ...
                <tr>
                    <td>
                        ...
                        <?php _e( 'Only available in Pro Addon', 'bulk-delete' ); ?> <a
                                    href="http://bulkwp.com/addons/bulk-delete-user-meta/?utm_source=wpadmin&utm_campaign=BulkDelete&utm_medium=buynow&utm_content=bd-m-u"
                ...
                <tr>
                    <td>
                        ...
                        <input name="smbd_um_key" id="smbd_um_key"
            ...
            <table class="optiontable">
                ...
                <tr>
                    <td>
                        ...
                        <input type="textbox" name="smbd_um_limit_to" id="smbd_um_limit_to" disabled value="0"
                               maxlength="4" size="4"><?php _e( 'users.', 'bulk-delete' ); ?>
                ...
                <tr>
                    <td>
                        <input name="smbd_um_cron" value="false" type="radio"
                               checked="checked"> <?php _e( 'Delete now', 'bulk-delete' ); ?>
                        <input name="smbd_um_cron" value="true" type="radio" id="smbd_um_cron"
                               disabled> <?php _e( 'Schedule', 'bulk-delete' ); ?>
                        <input name="smbd_um_cron_start" id="smbd_um_cron_start" value="now" type="text"
                        ...
                        <?php _e( 'Only available in Pro Addon', 'bulk-delete' ); ?> <a
                                    href="http://bulkwp.com/addons/bulk-delete-user-meta/?utm_source=wpadmin&utm_campaign=BulkDelete&utm_medium=buynow&utm_content=bd-m-u">Buy now</a>
                    </span>
                    </td>
                </tr>
        ...
        <p>
            <button type="submit" name="bd_action" value="delete_meta_user" class="button-primary">

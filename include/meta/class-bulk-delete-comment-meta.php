            ...
            <tr>
                <td>
                    ...
                    <span class="bd-cm-pro" style="color:red; vertical-align: middle;">
                        <?php _e( 'Only available in Pro Addon', 'bulk-delete' ); ?> <a href = "http://bulkwp.com/addons/bulk-delete-comment-meta/?utm_source=wpadmin&utm_campaign=BulkDelete&utm_medium=buynow" target="_blank">Buy now</a>
                    </span>
                </td>
            </tr>
...
?>
                    ...
                    <span class="bd-cm-pro" style="color:red">
                        <?php _e( 'Only available in Pro Addon', 'bulk-delete' ); ?> <a href = "http://bulkwp.com/addons/bulk-delete-comment-meta/?utm_source=wpadmin&utm_campaign=BulkDelete&utm_medium=buynow">Buy now</a>
                    </span>
                </td>
            </tr>
...
<?php
    ...
    public static function do_delete_comment_meta() {
        ...
        $delete_options['post_type'] = array_get( $_POST, 'smbd_cm_post_type', 'post' );

        $delete_options['use_value'] = array_get( $_POST, 'smbd_cm_use_value', 'false' );
        $delete_options['meta_key']  = array_get( $_POST, 'smbd_cm_key', '' );

        $delete_options['limit_to']  = absint( array_get( $_POST, 'smbd_cm_limit_to', 0 ) );

        $delete_options['restrict']  = array_get( $_POST, 'smbd_cm_restrict', FALSE );

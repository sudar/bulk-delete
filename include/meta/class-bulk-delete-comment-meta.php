...
class Bulk_Delete_Comment_Meta {
	...
	public static function render_delete_comment_meta_box() {
        ...
        <fieldset class="options">
            ...
            <table class="optiontable">
				...
				foreach ( $types as $type ) {
                    ...
                    <tr>
                        <td>
                            <input name="smbd_cm_post_type" value="<?php echo $type; ?>" type="radio"
                                   class="smbd_cm_post_type" <?php checked( $type, 'post' ); ?>>
            ...
            <table class="optiontable">
                ...
                <tr>
                    <td>
                        ...
                        <?php _e( 'Only available in Pro Addon', 'bulk-delete' ); ?> <a
                                    href="http://bulkwp.com/addons/bulk-delete-comment-meta/?utm_source=wpadmin&utm_campaign=BulkDelete&utm_medium=buynow&utm_content=bd-m-c"
                ...
                <tr>
                    <td>
                        ...
                        <input name="smbd_cm_key" id="smbd_cm_key"
            ...
            <table class="optiontable">
                ...
                <tr>
                    <td>
                        ...
                        <input type="number" name="smbd_cm_days" id="smbd_cm_days" disabled value="0" maxlength="4"
                               size="4"><?php _e( 'days', 'bulk-delete' ); ?>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        ...
                        <input type="number" name="smbd_cm_limit_to" id="smbd_cm_limit_to" disabled value="0"
                               maxlength="4" size="4"><?php _e( 'comments.', 'bulk-delete' ); ?>
                ...
                <tr>
                    <td>
                        <input name="smbd_cm_cron" value="false" type="radio"
                               checked="checked"> <?php _e( 'Delete now', 'bulk-delete' ); ?>
                        <input name="smbd_cm_cron" value="true" type="radio" id="smbd_cm_cron"
                               disabled> <?php _e( 'Schedule', 'bulk-delete' ); ?>
                        <input name="smbd_cm_cron_start" id="smbd_cm_cron_start" value="now" type="text"
                        ...
                        <?php _e( 'Only available in Pro Addon', 'bulk-delete' ); ?> <a
                                    href="http://bulkwp.com/addons/bulk-delete-comment-meta/?utm_source=wpadmin&utm_campaign=BulkDelete&utm_medium=buynow&utm_content=bd-m-c">Buy now</a>
                    </span>
                    </td>
                </tr>
        ...
        <p>
            <button type="submit" name="bd_action" value="delete_meta_comment" class="button-primary">

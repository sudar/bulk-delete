...
class Bulk_Delete_Post_Meta {
	...
	public static function render_delete_post_meta_box() {
        ...
        <fieldset class="options">
            ...
            <table class="optiontable">
				...
				foreach ( $types as $type ) {
                    ...
                    <tr>
                        <td>
                            <input name="smbd_pm_post_type" value="<?php echo $type; ?>" type="radio"
                                   class="smbd_pm_post_type" <?php checked( $type, 'post' ); ?>>
            ...
            <table class="optiontable">
                ...
                <tr>
                    <td>
                        ...
                        <?php _e( 'Only available in Pro Addon', 'bulk-delete' ); ?> <a
                                    href="http://bulkwp.com/addons/bulk-delete-post-meta/?utm_source=wpadmin&utm_campaign=BulkDelete&utm_medium=buynow&utm_content=bd-m-p"
                ...
                <tr>
                    <td>
                        ...
                        <input name="smbd_pm_key" id="smbd_pm_key"
            ...
            <table class="optiontable">
                ...
                <tr>
                    <td>
                        ...
                        <input type="textbox" name="smbd_pm_days" id="smbd_pm_days" disabled value="0" maxlength="4"
                ...
                <tr>
                    <td>
                        ...
                        <input type="textbox" name="smbd_pm_limit_to" id="smbd_pm_limit_to" disabled value="0"
                               maxlength="4" size="4"><?php _e( 'posts.', 'bulk-delete' ); ?>
                ...
                <tr>
                    <td>
                        <input name="smbd_pm_cron" value="false" type="radio"
                               checked="checked"> <?php _e( 'Delete now', 'bulk-delete' ); ?>
                        <input name="smbd_pm_cron" value="true" type="radio" id="smbd_pm_cron"
                               disabled> <?php _e( 'Schedule', 'bulk-delete' ); ?>
                        <input name="smbd_pm_cron_start" id="smbd_pm_cron_start" value="now" type="text"
                        ...
                        <?php _e( 'Only available in Pro Addon', 'bulk-delete' ); ?> <a
                                    href="http://bulkwp.com/addons/bulk-delete-post-meta/?utm_source=wpadmin&utm_campaign=BulkDelete&utm_medium=buynow&utm_content=bd-m-p">Buy now</a>
                    </span>
                    </td>
                </tr>
        ...
        <p>
            <button type="submit" name="bd_action" value="delete_meta_post" class="button-primary">
